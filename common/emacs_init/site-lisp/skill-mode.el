...
; modified  16/0505 by Eric Chang : change "\\<" and "\\>" regular expressions to "\\_<" and "\\_>" so underscores are treated correctly.
;                                   only works on Emacs 22 or later.
...
(defconst skill-font-lock-keywords-1
  (list
       (cons (concat "\\_<" (regexp-opt '( "add1" "and" "apply" "argc" "argv" "arrayp" "arrayref" "atof" "atoi" "atom" "band" "begin" "bitfield1" "bitfield"
       ...
       (cons (concat "\\_<" (regexp-opt '("nil" "t") t)  "\\_>")  'font-lock-constant-face)
...
(defconst skill-font-lock-keywords-2
  (append skill-font-lock-keywords-1
          (list
           (cons (concat "\\_<" (regexp-opt '( "append" "append1" "bcdp" "buildString" "caar" "caaar" "caadr" "cadr" "caddr" "cdar" "cddr" "car" "cdr" "cdsGetInstPath"
...
(defconst skill-font-lock-keywords-3
  (append skill-font-lock-keywords-2
          (list
           (cons (concat "\\_<" (regexp-opt '("abs" "acos" "addDefstructClass" "alias" "alphalessp" "alphaNumCmp" "asin" "assoc" "assq" "assv" "atan"
